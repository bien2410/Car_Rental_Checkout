...
DROP TABLE IF EXISTS `tblmortgage`;
...
LOCK TABLES `tblmortgage` WRITE;
/*!40000 ALTER TABLE `tblmortgage` DISABLE KEYS */;
INSERT INTO `tblmortgage` VALUES ('M1','So hong'),('M2','Can cuoc cong dan'),('M3','Tien mat');
/*!40000 ALTER TABLE `tblmortgage` ENABLE KEYS */;
UNLOCK TABLES;
